function analyseRicoCorretora(finalString) {
	var irrf = getFromBetween.get(finalString, RICO_CORRETORA.IRRF_DAY_TRADE_FIRST_WORD, RICO_CORRETORA.IRRF_DAY_TRADE_SECOND_WORD)
	var code = getFromBetween.get(finalString, RICO_CORRETORA.CLIENT_CODE_FIRST_WORD, RICO_CORRETORA.CLIENT_CODE_SECOND_WORD)
	var date = getFromBetween.get(finalString, RICO_CORRETORA.DATE_FIRST_WORD, RICO_CORRETORA.DATE_SECOND_WORD)
	var number = getFromBetween.get(finalString, RICO_CORRETORA.NOTE_NUMBER_FIRST_WORD, RICO_CORRETORA.NOTE_NUMBER_SECOND_WORD)
	var fees = getFromBetween.get(finalString, RICO_CORRETORA.TOTAL_FEES_FIRST_WORD, RICO_CORRETORA.TOTAL_FEES_SECOND_WORD)
	var gross = getFromBetween.get(finalString, RICO_CORRETORA.GROSS_VALUE_FIRST_WORD, RICO_CORRETORA.GROSS_VALUE_SECOND_WORD)
	var net = getFromBetween.get(finalString, RICO_CORRETORA.NET_VALUE_FIRST_WORD, RICO_CORRETORA.NET_VALUE_SECOND_WORD)
...
const RICO_CORRETORA = {
    ...
    DATE_SECOND_WORD: "Rico Investimentos",
